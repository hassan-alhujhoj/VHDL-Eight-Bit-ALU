...
set rc [catch {
  ...
  set_property ip_repo_paths p:/ENEL373/theALUProject/theALUProject.cache/ip [current_project]
  set_property ip_output_repo p:/ENEL373/theALUProject/theALUProject.cache/ip [current_project]
  add_files -quiet P:/ENEL373/theALUProject/theALUProject.runs/synth_1/main.dcp
